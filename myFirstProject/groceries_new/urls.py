...
urlpatterns = [
    ...
    path("userdetail/<int:pk>/", views.UserDetailView.as_view(template_name="userdetail.html"), name="userdetail"),
    ...
    path("products",prod_views.product_list,name='product_list'),
